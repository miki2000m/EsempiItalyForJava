package MODULO_5_INTERAGIRE_CON_IL_MONDO_ESTERNO.dLocalizzazione;
...
public class MainLocalizzazione {
    ...
    private static void sezione3_TradurreTestiConResourceBundle() {
        ...
        ResourceBundle messaggi = ResourceBundle.getBundle("MODULO_5_INTERAGIRE_CON_IL_MONDO_ESTERNO.Localizzazione.messaggi", localeScelto);
