 ...
 *
 * Questo file implementa un semplice Server TCP().
 *
 * Il protocollo TCP (Transmission Control Protocol) è un protocollo di comunicazione
 * orientato alla connessione che garantisce una trasmissione affidabile
